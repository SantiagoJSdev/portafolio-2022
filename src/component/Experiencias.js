...
export const Experiencias = () => {
    ...
    return (<>
        ...
        <div className='experiencias__contenido'>
            <div className={user.mode ? 'experiencias__contenido--title-mode' : 'experiencias__contenido--title'}><h1>Experiencia</h1></div>
            <div className={user.mode ? 'experiencias__contenido--content-mode' : 'experiencias__contenido--content'}>
                ...
                <div><h3>Tecnopac. Mar. 2022</h3><h1> <a href='https://una-idea.herokuapp.com/' target="blank">Proyecto EstuHouse: Desarrollo inicial WebApp para una empresa alquiler de apartamentos, inicio sesión usuario, inicio Google, notificaciones de correo electrónico(Nodemailer), panel administrador, panel usuario, manejo de la data.</a></h1> <p>JavaScript / React / HTML5 / CSS3 / Node.js / Express / Mongoose / Mongodb</p></div>
                ...
                <div><h3>Bootcamp soy Henry. Mar. 2022</h3><h1> <a href='https://pg-henry.vercel.app/' target="blank">Proyecto E-commerce: Desarrollo e-commerce, registro usuario, inicio Google, notificaciones de correo electrónico, panel administrador, panel usuario, manejo de la data, mercadopago, JSON Web Token (JWT).</a></h1> <p>JavaScript / React / HTML5 / CSS3 / Node.js / Express / Sequelize / PostgreSQL</p></div>
